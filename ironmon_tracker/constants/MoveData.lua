...
MoveData.MOVES_MASTER_LIST = {
	...
	},
	{
		...
		accuracy = "60",
		category = MoveData.MOVE_CATEGORIES.SPECIAL,
		description = "Inflicts regular damage. Has a 50% chance to paralyze the target."
	},
	{
		id = "193",
		name = "Foresight",
	...
	},
	{
		...
		accuracy = "70",
		category = MoveData.MOVE_CATEGORIES.PHYSICAL,
		description = "Inflicts regular damage and makes contact. Has a 50% chance to confuse the target."
	},
	{
		id = "224",
		name = "Megahorn",
